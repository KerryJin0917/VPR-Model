#!/usr/bin/env python3
"""
COMP560 Visual Place Recognition Training Example

Demonstrates how to train a ResNet50-based VPR model using
contrastive learning with the provided Parquet datasets, and how to
generate prediction CSV files for submission.

Usage (training):
    python train_example.py --data_root ./datasets/dataset_b --epochs 10
...
This script loads training data from Parquet files. VPR training uses
place-based identity labels to learn location-discriminative embeddings.
Students should design their own training strategies for best performance.
"""
...
class TrainableModel(nn.Module):
    """ResNet50 backbone with projection head for VPR training."""
